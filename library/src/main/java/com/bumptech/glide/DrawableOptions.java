...
interface DrawableOptions {
     ...
     * {@link android.graphics.drawable.Drawable}. If no placeholder is set, the Drawable will
     * instead
     * simply fade in.
     *
    ...
    /**
     * Applies a cross fade transformation that fades from the placeholder to the loaded
     * {@link android.graphics.drawable.Drawable}. If no placeholder is set the Drawable will instead
     * simply fade in.
     *
     ...
     * which results in
     * views animating repeatedly. Use {@link #crossFade(int, int)}} instead, or be sure to call this
     * method once

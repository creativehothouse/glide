...
/**
 * A class for handling requests to load a generic resource type or transcode the generic resource
 * type into another
...
public class GenericTranscodeRequest<ModelType, DataType, ResourceType>
    ...
    GenericTranscodeRequest(Class<ResourceType> transcodeClass,
            GenericRequestBuilder<ModelType, ?, ?, ?> other, ModelLoader<ModelType, DataType> modelLoader,
            Class<DataType> dataClass, Class<ResourceType> resourceClass,
            RequestManager.OptionsApplier optionsApplier) {
        super(build(other.glide, modelLoader, dataClass, resourceClass,
                UnitTranscoder.<ResourceType>get()), transcodeClass, other);
    ...
    GenericTranscodeRequest(Context context, Glide glide, Class<ModelType> modelClass,
            ...
            Class<ResourceType> resourceClass, RequestTracker requestTracker, Lifecycle lifecycle,
            RequestManager.OptionsApplier optionsApplier) {
    ...
    private static <A, T, Z, R> LoadProvider<A, T, Z, R> build(Glide glide,
            ModelLoader<A, T> modelLoader, Class<T> dataClass, Class<Z> resourceClass,
    ...
    /**
     * Adds a transcoder to this request to transcode from the resource type to the given transcode
     * type.
     *
    ...
    public <TranscodeType> GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> transcode(
        ...
        LoadProvider<ModelType, DataType, ResourceType, TranscodeType> loadProvider =
                build(glide, modelLoader, dataClass, resourceClass, transcoder);
    ...
    private GenericRequestBuilder<ModelType, DataType, File, File> getDownloadOnlyRequest() {
        ...
        FixedLoadProvider<ModelType, DataType, File, File> fixedLoadProvider =
                new FixedLoadProvider<ModelType, DataType, File, File>(modelLoader, transcoder,
                        dataLoadProvider);
        return optionsApplier.apply(
                new GenericRequestBuilder<ModelType, DataType, File, File>(fixedLoadProvider, File.class,
                        this))

...
public class GifTypeRequest<ModelType> extends GifRequestBuilder<ModelType> {
    ...
    GifTypeRequest(GenericRequestBuilder<ModelType, ?, ?, ?> other,
        ...
        super(buildProvider(other.glide, streamModelLoader, GifDrawable.class, null), GifDrawable.class,
                other);
    ...
    private static <A, R> FixedLoadProvider<A, InputStream, GifDrawable, R> buildProvider(Glide glide,
        ...
        DataLoadProvider<InputStream, GifDrawable> dataLoadProvider =
                glide.buildDataProvider(InputStream.class, GifDrawable.class);
    ...
    public <R> GenericRequestBuilder<ModelType, InputStream, GifDrawable, R> transcode(
        ...
        return optionsApplier.apply(
                new GenericRequestBuilder<ModelType, InputStream, GifDrawable, R>(provider, transcodeClass,
                        this));
    }
     ...
     * <p>
     * Note - Any transformations added during this load do not change the underlying bytes and
     * therefore this
     * will always load and provide the bytes of the original image before any transformations to the
     * given target.
     * </p>
     *
     * @return A new MarketplaceBuilder object to build a request to transform the given model into
     * the bytes of an animated gif.
     */

...
public interface ResourceDecoder<T, Z> {
     ...
     * The returned {@link Resource} will be {@link Resource#recycle() released} when the engine sees
     * fit.
     * </p>
     * <p>
    ...
    /**
     * Returns an ID identifying any transformation this decoder may apply to the given data that
     * will
     * be mixed in to
     * the cache key.
     * <p>

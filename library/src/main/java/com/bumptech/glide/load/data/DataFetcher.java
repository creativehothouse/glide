 ...
 * called for any given load depending on whether or not the corresponding resource is cached.
 * Cancel also may or may
 * not be called. If {@link #loadData(Priority)} is called, then so {@link #cleanup()} will be
 * called.
 *
...
public interface DataFetcher<T> {
     ...
     * <p>
     * <p>
     * A hash of the bytes of the data that will be fetched is the ideal id but since that is in many
     * cases
     * impractical, urls, file paths, and uris are normally sufficient.
     * </p>
     * <p>
     * <p>
     * Note - this method will be run on the main thread so it should not perform blocking operations
     * and should
     * finish quickly.
     * </p>
     */
     ...
     * to guarantee that any in process loads do not finish. It also may be called before a load
     * starts or after it
     * finishes.
     * <p>
     * <p>
     ...
     * those that are in
     * process to finish since its we typically will want to display the same resource in a different
     * view in
     * the near future.
     * </p>
     * <p>

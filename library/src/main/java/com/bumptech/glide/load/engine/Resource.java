...
public interface Resource<Z> {
     ...
     * <p>
     * Note - This does not have to be the same instance of the wrapped resource class and in fact it
     * is often
     ...
     * <li>After all consumers have released this resource and it has been evicted from the
     * cache</li>
     * </ul>
     * <p>
     * For most users of this class, the only time this method should ever be called is during
     * transformations or
     * transcoders, the framework will call this method when all consumers have released this
     * resource
     * and it has

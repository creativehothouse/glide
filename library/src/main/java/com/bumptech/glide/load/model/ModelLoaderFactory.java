 ...
 * statically so should not
 * retain {@link Context} or any other objects that cannot be retained for the life of the
 * application. ModelLoaders
 * will not be retained statically so it is safe for any ModelLoader built by this factory to
 * retain
 * a reference to a
 * {@link Context}.
 *
...
public interface ModelLoaderFactory<T, Y> {
     ...
     *                  {@link ModelLoader}
     * @param factories A map of classes to factories that can be used to construct additional {@link
     *                  ModelLoader}s that

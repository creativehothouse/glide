...
/**
 * A {@link ModelLoader} for translating uri models into {@link InputStream} data. Capable of
 * handling 'http',
 * 'https', 'android.resource', 'content', and 'file' schemes. Unsupported schemes will throw an
 * exception in

 ...
 * the image is
 * greater than the given height or vice versa, and then crop the larger dimension to match the
 * given dimension.
 * <p>
...
public class CenterCrop extends BitmapTransformation {
    ...
    @Override
    public String getId() {
        return "CenterCrop.com.jet8.sdk.ui.screen.marketplace.glide.load.resource.bitmap";
    }
}

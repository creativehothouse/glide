...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    /**
     * Load and scale the image uniformly (maintaining the image's aspect ratio) so that the smallest
     * edge of the
    ...
    public static final Downsampler AT_LEAST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_LEAST.com.jet8.sdk.ui.screen.marketplace.glide.load.data.bitmap";
        }
    };
    /**
     * Load and scale the image uniformly (maintaining the image's aspect ratio) so that largest edge
     * of the image
    ...
    public static final Downsampler AT_MOST = new Downsampler() {
        ...
        protected int getSampleSize(int inWidth, int inHeight, int outWidth, int outHeight) {
            int maxIntegerFactor =
                    (int) Math.ceil(Math.max(inHeight / (float) outHeight, inWidth / (float) outWidth));
        ...
        @Override
        public String getId() {
            return "AT_MOST.com.jet8.sdk.ui.screen.marketplace.glide.load.data.bitmap";
        }
    };
    /**
    ...
    public static final Downsampler NONE = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "NONE.com.jet8.sdk.ui.screen.marketplace.glide.load.data.bitmap";
        }
    };
    private static final String TAG = "Downsampler";
    private static final Set<ImageHeaderParser.ImageType> TYPES_THAT_USE_POOL =
            EnumSet.of(ImageHeaderParser.ImageType.JPEG, ImageHeaderParser.ImageType.PNG_A,
     ...
     * those of the image
     * for the given InputStream is available, the operation is much less expensive in terms of
     * memory.
     * <p>
     * <p>
    ...
    public Bitmap decode(InputStream is, BitmapPool pool, int outWidth, int outHeight,
        ...
        try {
            ...
            final Bitmap downsampled =
                    downsampleWithSize(invalidatingStream, bufferedStream, options, pool, inWidth, inHeight,

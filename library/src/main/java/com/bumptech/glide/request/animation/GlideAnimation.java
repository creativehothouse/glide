 ...
 * provide all of the necessary arguments and start the animation. Those that do not will be unable
 * to provide the
 * necessary arguments and will therefore be forced to ignore the animation. This interface is a
 * compromise that
 * allows view animations in Glide's complex world of arbitrary resource types and arbitrary target
 * types.
 *
...
public interface GlideAnimation<R> {
     ...
     * @return True if int he process of running the animation the new resource was set on the view,
     * false if the caller

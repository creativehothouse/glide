...
/**
 * An interface that Glide can load a resource into and notify of relevant lifecycle events during
 * a
 * load.
 * <p>
 * <p>
 ...
 * guarantees. onLoadStarted may not be called if the resource is in memory or if the load will
 * fail
 * because of a
 * null model object. onLoadCleared similarly may never be called if the target is never cleared.
 * See the docs for
...
public interface Target<R> extends LifecycleListener {
     ...
     * Loads can be
     * paused and restarted due to lifecycle or connectivity events and each restart may cause a call
     * here.
     * </p>
     *
     ...
     * <p>
     * <p>
     * Note - This may be called before {@link #onLoadStarted(android.graphics.drawable.Drawable)} if
     * the model
     * object is null.
     * </p>
     *
     * @param e             The exception causing the load to fail, or null if no exception occurred (usually
     *                      because a decoder
